...
- `Provider.ollamaCloud`. Icon `ollama`. Extra accounts: no. Transcripts: no. First-run: offered unchecked, with no detected hint; a browser session is imported in Settings after selection.
